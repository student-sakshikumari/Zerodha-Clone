...
function ProductPage() {
    return (
        <>
            <Hero />
            <LeftSection 
                imagrURL="media/images/Kite.png"
                productName="Kite"
                ...
                oo seamiessly on your Android and iOS devices."
                tryDemo=""
                learnMore=""
                googlePlay=""
                appStore="" />
                <RightSection imagrURL="media/images/console.png"
                productName="Console"
                ...
                <LeftSection 
                imagrURL="media/images/coin.png"
                productName="Coin"
                ...
                googlePlay=""
                appStore="" />
                <RightSection imagrURL="media/images/Kiteconnect.png"
                ...
                <LeftSection 
                imagrURL="media/images/varsity.png"
