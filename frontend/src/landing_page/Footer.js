...
function Footer() {
    return ( 
        ...
        <div className='container border-top mt-5'>
           ...
           <p> Zerodha Broking Ltd .: Member of NSE
             CDSL: Depository services through Zerodha Securities Pvt. Ltd.
            IN-DP-100-2015 Commodity Trading through Zerodha Commodities Pvt. Ltd. MCX: 46025
           ...
           <p>Investments in securities market are subject to market risks; re
            documents carefully before investing.</p> 

           <p>"Prevent unauthorised transactions in your account. Update your
            with vour stock brokers. Receive information of your transaction.
            directly from Exchange on your mobile/email at the end of the day.Issued in the interest
            of investors. KYC is one time exercise while dealing in securities markets-once KYC is done 
            through a SEBI registrated intermidary (broker, DP, Mutual Fund etc.), you need not
            undergo the same process again when you approach another intermidary."Dear invertor",if
            you are subscribing to an IPO, there is no need to issue a cheque.Please write your number 
            and sign the IPO, application form to authorize your bank to account of allotment.
            In case of non allotment the funds will remain in your bank account business.
            we don't give stocks tips , and have not authorize anymore others.
            If you find anyone claiming to be part of Zerodha and please 
